...
A simple, Java desktop application for downloading YouTube videos as `.mp3` files — for **Spotify local files**. Built with `Swing`, supports real-time logs, history, and auto-folder updates.
